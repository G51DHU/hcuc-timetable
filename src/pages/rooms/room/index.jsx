...
import ImgBinWhite from '../../../assets/bin_white.png'
import ImgBinBlack from '../../../assets/bin_black.png'
  ...
  return (
    <details className='room'>
      <summary title={'Room: ' + name}>
        <h3> {name} </h3>
        <button>
          <img src={BinWhite ? ImgBinWhite : ImgBinBlack} onClick={() => OnClick()} alt='Trash icons created by Freepik - Flaticon' />
        </button>
      </summary>
      <ul>
